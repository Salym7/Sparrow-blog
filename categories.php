...
$post_categorie = mysqli_query($connect, "SELECT * FROM `post_categories` WHERE `id_categories` = $categorie_id");
$post_categorie = mysqli_fetch_all($post_categorie);
$posts = mysqli_query($connect, "SELECT * FROM `posts`");
$posts = mysqli_fetch_all($posts);
$filtered_post = [];

foreach ($post_categorie as $item) {
...
$categorie = mysqli_query($connect, "SELECT * FROM `tags` WHERE `id` = $categorie_id");
    ...
    <div id="page-title">
        ...
        <div class="row">
            ...
            <div class="ten columns centered text-center">
                <h1><?php echo $categorie['name']; ?><span>.</span></h1>
