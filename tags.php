...
$tag_id = $_GET['id'];
$post_tags = mysqli_query($connect, "SELECT * FROM `post_categories` WHERE `id_categories` = $tag_id");
...
$tag = mysqli_query($connect, "SELECT * FROM `tags` WHERE `id` = $tag_id");
    ...
    <div id="page-title">
        ...
        <div class="row">
            ...
            <div class="ten columns centered text-center">
                <h1><?php echo $tag['name']; ?><span>.</span></h1>
